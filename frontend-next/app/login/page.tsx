...
const LoginPage = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Testing credentials provided by user
    const TEST_EMAIL = "tester@enterprise.com"
    const TEST_PASSWORD = "12345"
    const TEST_COMPANY = "tester123"

    if (email === TEST_EMAIL && password === TEST_PASSWORD) {
      localStorage.setItem("user", JSON.stringify({ email, company: TEST_COMPANY }))
      router.push("/")
    } else {
  ...
  return (
    <StyledWrapper>
      <form className="form" onSubmit={handleLogin}>
        ...
        <div className="inputForm">
          <svg xmlns="http://www.w3.org/2000/svg" width={20} viewBox="0 0 24 24" height={20} fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
